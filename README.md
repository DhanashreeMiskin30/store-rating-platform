...
Install MySQL (8.0+ recommended) if you don't already have it running locally.
...
Configure .env in backend/ with your MySQL host/user/password (see below).
...
This drive  contain screenshots of the Login page, Admin Dashboard, Admin Users/Stores tables, Normal User store grid, and Store Owner dashboard here after running the app locally.
